...
import { Search, Filter, Star, Phone, Mail, ShoppingCart, Package, Wrench, Settings, Eye } from 'lucide-react';
      ...
      <div className="container-max">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center space-x-4">
            <a href="tel:9822006345" className="text-blue-600 hover:text-blue-700 flex items-center">
              <Phone size={16} className="mr-1" />
              98220 06345
            </a>
            <a href="mailto:copiersnasik@gmail.com" className="text-blue-600 hover:text-blue-700 flex items-center">
        ...
        <section className="mt-16">
          <div className="bg-blue-50 rounded-2xl shadow-lg px-8 py-10 flex flex-col items-center md:flex-row md:justify-between md:items-stretch gap-8">
            <div className="flex-1 flex flex-col items-center md:items-start justify-center text-center md:text-left">
              <h2 className="text-2xl font-bold text-gray-900 mb-2 flex items-center"><Package className="w-7 h-7 text-blue-600 mr-2" /> Need Help Finding the Right Part?</h2>
              <p className="text-gray-700 mb-4 max-w-xl">
                Our experts can help you identify the correct spare parts for your photocopier. Contact us with your machine model and we'll provide personalized recommendations.
              </p>
            </div>
            <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-4">
              ...
              <Link to="/contact" className="flex-1 flex items-center justify-center bg-white border border-blue-200 rounded-lg px-6 py-4 text-blue-700 font-semibold shadow-sm hover:bg-blue-100 transition">
                <Package className="w-5 h-5 mr-2" /> Visit Our Office
              </Link>
            </div>
          </div>
        </section>
