      ...
      <div className="container-max">
        ...
        <div className="mt-16 bg-blue-50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Our experts can help you select the perfect photocopier based on your volume requirements, 
            budget, and specific business needs. Contact us for personalized recommendations.
          </p>
